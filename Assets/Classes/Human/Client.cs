...
public class Client : MonoBehaviour
{
    ...
    public void StartSpawn(GameObject warningPrefab)
    {
        coroutine = StartCoroutine(SpawnChans(warningPrefab));
    }

    public IEnumerator SpawnChans(GameObject warningPrefab)
    {
        while (true)
        {
